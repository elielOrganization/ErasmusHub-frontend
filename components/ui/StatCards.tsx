        ...
        <>
            ...
            <div className="flex sm:hidden gap-2 overflow-x-auto pb-1 -mx-1 px-1">
                {items.map((item, i) => (
                    <div
                        key={i}
                        className="flex items-center gap-2.5 bg-white rounded-xl px-4 py-3 border border-gray-100 shadow-sm min-w-0 flex-1"
                    >
                        {item.icon && (
            ...
            <div className={`hidden sm:grid gap-4 ${
                ...
                {items.map((item, i) => (
                    <div
                        key={i}
                        className="group bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex items-center gap-4"
                    >
                        {item.icon && (
                        ...
                        <div>
                            <p className={`text-2xl font-bold leading-none ${item.color || 'text-gray-800'}`}>
                                {item.value}
                            </p>
